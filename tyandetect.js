...
var q = [
    ...
    [8,1,'Может отвечать на сообщение, параллельно разговаривая с человеком? (может выполнять 2 и более дел одновременно)',[['Да',0.1],['Нет',-0.1]]],
...
function summary()
{
    ...
    for(var i = 0; i < s.length; i++) {
        stat('by_question_all',s);
        stat('by_question_'+result,s);
    }
